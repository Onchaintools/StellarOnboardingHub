          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-bold text-[#333333] font-sans">Transaction Simulator</h1>
                <p className="text-sm text-gray-600">Practice safe transactions risk-free</p>
              </div>
            </div>
                ...
                <div key={stepNum} className="flex items-center">
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-semibold text-sm sm:text-base ${
                      step >= stepNum ? "bg-[#EECB01] text-[#333333]" : "bg-gray-200 text-gray-500"
                    }`}
                  >
                    {stepNum}
                  </div>
              ...
              {step === 1 && (
                <Card className="w-full border-2 border-[#EECB01]/20 shadow-xl">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl text-[#333333] font-sans">Your Digital Wallet</CardTitle>
                    <p className="text-gray-600">This is a simulated wallet for learning purposes</p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-[#EECB01]/10 to-[#8E7CE5]/10 p-6 rounded-lg text-center">
                      ...
                      <div className="text-3xl font-bold text-[#333333] mb-1">${simulatorBalance.toFixed(2)}</div>
                      <div className="text-sm text-gray-500">USD</div>
                    </div>

                    {/* Wallet Address */}
                    <div className="space-y-2">
                      <Label className="text-[#333333] font-medium">Your Wallet Address</Label>
              ...
              {step === 2 && (
                <Card className="w-full border-2 border-[#8E7CE5]/20 shadow-xl">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl text-[#333333] font-sans">Send Money</CardTitle>
                    <p className="text-gray-600">Enter transaction details</p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="recipient" className="text-[#333333] font-medium">
                        Recipient Address *
                      </Label>
                      <Input
                        id="recipient"
                        ...
                        className="font-mono text-sm w-full"
                      />
                      <p className="text-xs text-gray-500">Enter the destination wallet address</p>
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="amount" className="text-[#333333] font-medium">
                        Amount (USD) *
                      </Label>
                      <Input
                        id="amount"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="memo" className="text-[#333333] font-medium">
                        Memo (Optional)
                      </Label>
                      <Input
                        id="memo"
                        ...
                        className="w-full"
                      />
                      <p className="text-xs text-gray-500">{memo.length}/28 characters</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      ...
                      <div className="flex justify-between text-sm font-semibold">
                        ...
                        <span>${(Number.parseFloat(amount) + transactionFee || transactionFee).toFixed(6)}</span>
                      </div>
                    </div>
              ...
              {step === 3 && (
                <Card className="w-full border-2 border-orange-400/20 shadow-xl">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl text-[#333333] font-sans">Review Transaction</CardTitle>
                    <p className="text-gray-600">Double-check all details before sending</p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 p-4 rounded-lg">
                      <div className="flex items-center space-x-2 mb-3">
                        <AlertTriangle className="w-5 h-5 text-orange-600" />
                        <span className="font-semibold text-orange-800">Important Reminder</span>
                      </div>
                      <p className="text-sm text-orange-700">
                        Digital transactions are irreversible. Please verify all details carefully.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between py-3 border-b">
                        ...
                        <span className="font-mono text-sm text-[#333333]">GCKF...LPQV (Your Wallet)</span>
                      </div>
                      <div className="flex justify-between py-3 border-b">
                      ...
                      <div className="flex justify-between py-3 border-b">
                        ...
                        <span className="text-xl font-bold text-[#333333]">${amount}</span>
                      </div>
                      <div className="flex justify-between py-3 border-b">
                        <span className="text-gray-600">Fee:</span>
                        <span className="text-[#333333]">${transactionFee.toFixed(6)}</span>
                      </div>
                      {memo && (
                        <div className="flex justify-between py-3 border-b">
                      ...
                      <div className="flex justify-between py-3 font-semibold text-lg">
                        ...
                        <span className="text-[#333333]">
                          ${(Number.parseFloat(amount) + transactionFee).toFixed(6)}
                        </span>
                      </div>
                    </div>
              ...
              {step === 4 && (
                <Card className="w-full border-2 border-green-500 bg-green-50 shadow-xl">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl text-green-800 font-sans">Transaction Successful! 🎉</CardTitle>
                    <p className="text-green-600">Your simulated transaction has been completed</p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      <div className="text-center mb-4">
                        <div className="text-sm text-gray-600 mb-1">Transaction Hash</div>
                        <div className="font-mono text-sm text-[#333333] bg-gray-100 p-2 rounded overflow-x-auto sm:overflow-x-visible sm:whitespace-normal whitespace-nowrap text-ellipsis">
  a1b2c3d4e5f6789012345678901234567890abcdef1234567890abcdef123456
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <div className="font-semibold">${transactionFee.toFixed(6)}</div>
                        </div>
                        <div>
                          <div className="text-gray-600">New Balance</div>
                          <div className="font-semibold">
                            ${(simulatorBalance - Number.parseFloat(amount) - transactionFee).toFixed(2)}
                          </div>
                        </div>
                        <div>
                    ...
                    <div className="bg-[#EECB01]/20 p-4 rounded-lg">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="font-semibold text-[#333333]">Learning Reward</span>
                      </div>
                      <p className="text-sm text-gray-700">
                        Great job! You've earned 25 XP for completing the transaction simulator.
                      </p>
                    </div>
            ...
            <div className="space-y-6 w-full">
              ...
              <Card className="w-full border-2 border-[#EECB01]/20">
                ...
                <CardContent className="space-y-3 text-sm">
                  <div>
                    <div className="font-semibold text-[#333333]">Transaction Speed</div>
                    <div className="text-gray-600">2-5 seconds average</div>
                  </div>
                  <div>
                    <div className="font-semibold text-[#333333]">Network Fee</div>
                    <div className="text-gray-600">$0.000125 (~0.0001%)</div>
                  </div>
                  <div>
                    <div className="font-semibold text-[#333333]">Daily Volume</div>
                    <div className="text-gray-600">$50M+ processed daily</div>
                  </div>
                  <div>
                    <div className="font-semibold text-[#333333]">Energy Efficient</div>
